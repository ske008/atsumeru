      ...
      <div className="stack">
        ...
        {event.collecting && (
          <section className="card" style={{ background: "#EEF4F0", borderColor: "#b7e1cb" }}>
            <h2 className="h2">é›†é‡‘ã®ã”æ¡ˆå†…</h2>
            <p style={{ fontSize: "1.3rem", fontWeight: 700, marginTop: 8 }}>
              Â¥{event.amount.toLocaleString()}<span style={{ fontSize: "0.75rem", fontWeight: 500, color: "#6B6B67", marginLeft: 4 }}>/ 1äºº</span>
            </p>
            {event.pay_url && <p className="hint" style={{ marginTop: 6 }}>å‚åŠ å›ç­”å¾Œã«ã‚ªãƒ³ãƒ©ã‚¤ãƒ³é€é‡‘ã§ãã¾ã™</p>}
          </section>
        )}
